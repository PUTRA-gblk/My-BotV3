...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: 'Khusus _*OWNER*_!',
    owner: 'Khusus _*Owner Bot*_!',
    mods: 'Khusus _*Moderator*_ !',
    premium: 'Khusus member _*Premium*_ !',
    group: 'Khusus _*Group*_!',
    private: 'Khusus _*Pc / Pribadi*_!',
    admin: 'Khusus _*Admin Group*_!',
    botAdmin: 'Jadikan bot sebagai *Admin* !',
    unreg: '*「 BELUM TERDAFTAR 」* \nHalo Kak, Yuk Daftar Dulu Soalnya Anda Belum Terdaftar Dalam Database Bot\n\nKetik : #daftar nama|umur\nContoh : #daftar PutraGanzz|16'
  }[type]
