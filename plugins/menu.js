...
await conn.fakeReply(m.chat, '*「 Bentar Kak 」*', '0@s.whatsapp.net', '*Menampilkan List Menu*', 'status@broadcast')
...
├◪ *STATUS BOT*
││
│├❒ Total User : *%totalreg* Pengguna
│├❒ Total Group : *${groupsIn.length}* Group Chat
│├❒ Total Chat : *${chats.length}* Total Chat
│├❒ Runtime : _%uptime_ Online
